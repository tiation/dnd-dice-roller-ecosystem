...
import { determinePortrait } from '@/lib/portraitUtils'
import { defaultPortrait } from '@/lib/characterPortraits'
...
export default function CharacterPortraitGenerator() {
  ...
  const handleGenerate = async () => {
    ...
    // Generate a D&D character portrait based on description and style
            ...
            <CardContent>
              {generatedPortrait ? (
                <div className="space-y-4">
                  <div className="character-portrait-animated group">
                    <img 
                ...
                <div className="aspect-square flex items-center justify-center border-2 border-dashed border-amber-400/30 rounded-lg">
                  <div className="text-center space-y-3">
                    <img 
                      src={defaultPortrait}
                      alt="Default character portrait"
                      className="h-32 w-32 mx-auto opacity-50"
                    />
                    <p className="text-amber-200/70 font-serif mt-4">
                      Your epic character portrait will appear here
                    </p>
                  </div>
                </div>
              )}
