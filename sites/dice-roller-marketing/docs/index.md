---
layout: default
title: Dice Roller Marketing Site - Enterprise Solution
...
<div class="tiation-hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">
      ...
      <span class="gradient-text">Dice Roller Marketing Site</span>
    </h1>
    ...
    <div class="hero-cta">
      ...
      <a href="https://github.com/tiation/dice-roller-marketing-site" class="btn-tertiary">📁 View Code</a>
    </div>
  </div>
</div>
...
```bash
# Build Docker image
docker build -t dice-roller-marketing-site .

# Run container
docker run -p 8080:8080 dice-roller-marketing-site
```
...
### 📞 Getting Help
- **📚 Documentation**: [Full documentation](https://tiation.github.io/dice-roller-marketing-site)
- **❓ FAQ**: [Frequently asked questions](faq.md)
- **🐛 Issues**: [GitHub Issues](https://github.com/tiation/dice-roller-marketing-site/issues)
- **💬 Discussions**: [GitHub Discussions](https://github.com/tiation/dice-roller-marketing-site/discussions)
